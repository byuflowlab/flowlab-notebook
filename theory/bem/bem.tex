...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.25in]{annulus}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{turbine-cv}
\caption{c}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{velocity-deficit1}
\caption{}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{velocity-deficit2}
\caption{}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.0in]{wtvt}
\caption{}
\label{fig:wtvt}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{inflow1}
\caption{caption}
\label{fig:inflow1}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{inflow2}
\caption{caption}
\label{fig:inflow2}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{inflow3}
\caption{caption}
\label{fig:inflow3}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=3.5in]{inflow4}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{inflow5}
\caption{}
\label{fig:inflowv}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{inflowprop}
\caption{}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=2.5in]{quadrants}
\caption{caption}
\label{fig:quadrants}
\end{figure}
...
%NOTE Judd changed this from subfig to caption/subcaption syntax since it's basically the same, but caption/subcaption is newer and works better in the airfoilparams 2x2 figure(s)
%\begin{figure}[htbp]
%\centering
% \subfloat[Side view of curved blade.  Coordinate system is normal to curvature.]{
%   \makebox[3.0in][c]{\includegraphics[height=2.5in]{curved}}
%   \label{fig:curved}
% }
% \qquad
...
%   \makebox[3.0in][c]{\includegraphics[height=2.5in]{swept}}
%   \label{fig:swept}
% }
...
\begin{figure}[htbp]
	\centering
	\begin{subfigure}[t]{3.0in} % width of left subfigure
		\centering
		\includegraphics[height=2.5in]{curved}
		\caption{Side view of curved blade.  Coordinate system is normal to curvature.}
		\label{fig:curved}
	\end{subfigure}
	\begin{subfigure}[t]{3.0in} % width of right subfigure
		\centering
		\includegraphics[height=2.5in]{swept}
		\caption{Front view of swept blade.  Sweep is accomplished through shearing, so coordinate system stays parallel to sweep of blade root.}
		\label{fig:swept}
	\end{subfigure}
	\caption{Definition of local airfoil coordinate system.}
	\label{fig:csys}
